...
class favorite_recipe_profile_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val allRecipe = ImageManagement.findFavoriteRecipe(inflater.context)
        ...
        binding.profileBTBBack.setOnClickListener {
            Navigation.findNavController(binding!!.root).navigate(R.id.action_favorite_recipe_profile_Fragment_to_viewFavoriteRecipeFragment)
        }
